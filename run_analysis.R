...
cleanedData <- filtered_data

## Save & Write out the 1st dataset with the name "merged_data.txt"
...
## Save & Write out the 2nd dataset with the name "data_with_means.txt"
write.table(result, file=""data_with_means.txt") 
